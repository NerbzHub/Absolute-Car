...
public class scrp_Player : MonoBehaviour
{
    ...
    //--------------------------------------------------------------------------------------
    // Used for collisions to player
    //      Bullet Hit to alter score
    //      Ground hit to allow jumping again
    //
    // Param
    //		col: Time since last update
    //--------------------------------------------------------------------------------------
    void OnCollisionEnter(Collision col)
    {
        ...
        if (col.gameObject.tag == "Bullet")
        {
            ...
            ParticleSystem explosion = Instantiate(m_Explosion, col.gameObject.transform.position, transform.rotation);
